...
curl -o server.properties https:///pterodactyl-optimized-paper-egg/main/server.properties
fi
if [ ! -f paper.yml ]; then
echo -e "Downloading MC paper.yml"
curl -o paper.yml https://pterodactyl-optimized-paper-egg/main/paper.yml
fi
if [ ! -f spigot.yml ]; then
echo -e "Downloading MC spigot.yml"
curl -o spigot.yml https:///pterodactyl-optimized-paper-egg/main/spigot.yml
fi
if [ ! -f bukkit.yml ]; then
echo -e "Downloading MC bukkit.yml"
curl -o bukkit.yml https:///pterodactyl-optimized-paper-egg/main/bukkit.yml
fi
